  ...
  return (
    <div className="space-y-5">
      ...
      {result ? (
        ...
        <p className="rounded-xl border border-dashed border-border bg-white p-4 text-sm text-muted">Enter your nightly and daily costs to build a full trip budget with per-person and per-day figures.</p>
      )}
    </div>
  );
}
